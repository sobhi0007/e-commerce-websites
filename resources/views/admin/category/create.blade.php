   ...
   <form method="POST" action="{{url('admin/category')}}"  enctype="multipart/form-data">
      ...
      <div class="row">
         ...
         <div class="col-6 my-2"> 
            ...
            <input  type="text" class="rounded @error('slug') is-invalid @enderror form-control form-control-sm" id="slug" name="slug" value="{{ old('slug') }}">
         @error('slug')
            <small class="fw-bold   text-danger">{{ $message }}</small>
         @enderror
         </div>
         ...
         <div class="col-md-4 col-12 my-2"> 
            ...
            <input  type="text" class="rounded @error('meta_title') is-invalid @enderror form-control form-control-sm" id="meta_title" name="meta_title" value="{{ old('meta_title') }}">
         @error('meta_title')
            <small class="fw-bold   text-danger">{{ $message }}</small>
         @enderror
         </div>
         <div class="col-md-4 col-12 my-2"> 
            ...
            <input  type="text" class="rounded @error('meta_keyword') is-invalid @enderror form-control form-control-sm" id="meta_keyword" name="meta_keyword" value="{{ old('meta_keyword') }}">
         @error('meta_keyword')
            <small class="fw-bold   text-danger">{{ $message }}</small>
         @enderror
         </div>
         <div class="col-md-4 col-12 my-2"> 
            ...
            <input  type="text" class="rounded @error('meta_description') is-invalid @enderror form-control form-control-sm" id="meta_description" name="meta_description" value="{{ old('meta_description') }}">
